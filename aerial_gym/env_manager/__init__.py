...
from aerial_gym.config.env_config.dynamic_uav_env import QuadFlightDynamicEnvCfg
from aerial_gym.config.env_config.hard_dynamic_uav_env import HardQuadFlightDynamicEnvCfg
...
env_config_registry.register("dynamic_uav_env", QuadFlightDynamicEnvCfg)
env_config_registry.register("hard_dynamic_uav_env", HardQuadFlightDynamicEnvCfg)
