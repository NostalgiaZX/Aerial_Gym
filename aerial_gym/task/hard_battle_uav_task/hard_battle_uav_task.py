...
logger = CustomLogger("hard_battle_uav_task")
...
class HardBattleUavTask(BaseTask):
    def __init__(
        ...
        logger.info("Building environment for hard battle uav task.")
        logger.info(
        ...
        self.counter = 0
        self.uav_index = self.sim_env.get_assets_index("hard_dynamic_uav")
    ...
    def compute_obs_next_action(self):
        ...
        # hard_dynamic_uav 在障碍列表里的槽位对所有 env 相同，直接向量化赋值。
